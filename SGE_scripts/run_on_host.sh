...
PROJECT_HOME=/scratch_net/bmicdl03/code/python/discriminative_learning_toolkit/
VIRTUAL_ENV_PATH=/scratch_net/bmicdl03/code/python/environments/tensorflow1.8-gpu/
...
#$ -o /scratch_net/bmicdl03/logs/dileto/  ## <---------------- CHANGE TO MATCH YOUR SYSTEM
#
